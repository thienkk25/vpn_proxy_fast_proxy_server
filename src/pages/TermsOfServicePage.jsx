      ...
      <section className="section">
        <div className="container">
          <div className="contact-card" style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'left' }}>
            ...
            <p style={{ marginBottom: '30px', color: 'var(--text-muted)' }}>
              To the maximum extent permitted by applicable law, in no event shall we be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from (a) your access to or use of or inability to access or use the service; or (b) any unauthorized access, use, or alteration of your transmissions or content.
            </p>

            <h3 style={{ marginBottom: '16px', fontSize: '20px' }}>7. Changes to Terms</h3>
            <p style={{ marginBottom: '30px', color: 'var(--text-muted)' }}>
            ...
            <h3 style={{ marginBottom: '16px', fontSize: '20px' }}>8. Contact Information</h3>
            <p style={{ marginBottom: '30px', color: 'var(--text-muted)' }}>
